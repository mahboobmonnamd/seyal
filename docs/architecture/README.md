...
20a. [`../milestones/MILESTONE-002.md`](../milestones/MILESTONE-002.md) — M002 close-out contract: remaining issues #824 / #673 / #837, non-goals, IME honesty, and final validation recipe. Subordinate to ADR-010 / ADR-011 / ADR-015 and SPEC-010 / SPEC-011. Does not claim M002 Done.
...
- ADR-009 owns the accepted command-Block/composer baseline and the accepted #858 / PR #859 (`8d08f2f`) presentation amendment: one canonical terminal authority feeds mutually exclusive Flow/Raw/TUI presentation modes, Flow draws terminal pixels only in Block output regions, Raw/TUI are full-Pane takeovers, and a hidden/coexisting raw terminal input viewport under Flow is forbidden.
