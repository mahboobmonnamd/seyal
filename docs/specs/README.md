...
- [`SPEC-016-M005-DURABLE-ACTION-EFFECT-LIFECYCLE.md`](SPEC-016-M005-DURABLE-ACTION-EFFECT-LIFECYCLE.md) — **Proposed under #871:** immutable ActionIntent, exact approval consumption, atomic Dispatching boundary, dispatch fencing, crash/effect reconciliation, executor-specific idempotency and cancellation semantics under ADR-014.
