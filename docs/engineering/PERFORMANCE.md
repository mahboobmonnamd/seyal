...
distribution. Its `>5%` explanation and `>10%` blocking policy is enforced when
a controlled-run operator sets `SEYAL_PASS8_ENFORCE_REGRESSION_GATE=1`, and
automatically for a Pass 9 controlled calibration
