...
M001.1 freezes the current AppKit shell as deprecated (not product authority), implements portable product behavior in Rust, then replaces this tree with a new thin host. The freeze/authority map is `docs/engineering/M001.1-SWIFT-OWNERSHIP-PARITY-MANIFEST.md`; it does not replace this layout document.
