...
4. Do not introduce third-party Apple documentation indexes into Seyal tooling. If supplemental research is needed, verify every material API/design claim against first-party Apple evidence before making architecture or production decisions.
...
Generic web/frontend guidance is never authoritative for production AppKit/Metal behavior.
