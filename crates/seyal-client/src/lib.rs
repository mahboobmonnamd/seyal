...
//! portable headed product composition (Workspace/Tab/Pane), shell chrome
//! projection, Flow/Raw/TUI presentation fencing, composer/Block projection,
//! reconnect/recovery policy, and portable theme/config resolution.
//!
