...
Run the complete M001 suite and publish baselines. Owning Issue #727 **closed**. Aggregate PASS ledger: `docs/engineering/M001-PASS10-EVIDENCE.md`. Final freeze `c536c5454583f6a036910e145fe1187446319630`; last production behavior `a012ab0…` (#789); harness tip `e2b7602…` (#778). Machine RSS gate **`CLIENT_RSS_KIB = 1536`** unchanged by Pass 10 (#784).
