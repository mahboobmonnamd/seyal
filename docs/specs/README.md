...
- [`SPEC-006-M001-NATIVE-INPUT-RESIZE.md`](SPEC-006-M001-NATIVE-INPUT-RESIZE.md) — **Proposed for M001 Pass 7 / Issue #702:** AppKit input classification, committed-text vs semantic-key routing, Runtime-owned key encoding, Controller authority, bounded client input/control queuing, authoritative resize transaction, focus/IME/accessibility seam and latency acceptance.
