...
pub use ffi::{
    ...
    seyal_app_destroy, seyal_app_last_error, seyal_app_layout_count, seyal_app_layout_node,
    seyal_app_recovery_param, seyal_app_shell, seyal_app_shell_row, seyal_app_snapshot,
    seyal_app_theme, seyal_bridge_adopt_handle, seyal_bridge_disconnect_handle,
