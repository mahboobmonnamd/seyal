...
pub(crate) fn run_cohort(mode: LossMode, geometry: Geometry, cohort: usize) {
    ...
    println!(
        ...
        runtime_allocator_baseline.allocator_in_use_kib,
        runtime_final.allocator_in_use_kib,
        runtime_allocator_baseline.allocator_reserved_kib,
        runtime_final.allocator_reserved_kib,
        ...
        idle_cpu
            ...
            .collect::<Vec<_>>()
            .join(","),
        idle_cpu.p50_percent,
        idle_cpu.p95_percent,
        idle_cpu.max_percent,
        MEASURED_CYCLES,
        PERFORMANCE_CLAIM,
    );
    println!(
