...
16. [`ADR-015-RUST-PRODUCT-UI-THIN-SWIFT-HOST.md`](ADR-015-RUST-PRODUCT-UI-THIN-SWIFT-HOST.md) — **Accepted on merge:** Rust owns portable product/UI state and behavior; in-repo Swift is only a thin macOS adapter. No separate Swift UI tree and no deletion of the Swift host.
