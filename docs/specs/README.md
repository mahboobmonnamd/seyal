...
- [`SPEC-009-M001-DETACH-RECONNECT.md`](SPEC-009-M001-DETACH-RECONNECT.md) — **Proposed for M001 Pass 9 / Issue #717:** GUI detach/crash survival of the same live Runtime, PTY, child and `ExecutionId`; fresh attachment/controller state on reconnect; authoritative current-state reconstruction; Pass 8 Block continuity; bounded Controller-race recovery; and lifecycle/security/resource/performance acceptance without Runtime-crash PTY-survival claims.
