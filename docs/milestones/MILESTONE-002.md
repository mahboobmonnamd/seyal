...
Approved decomposition is **M002.1–M002.10** under #672, plus performance sibling #673. Snapshot **2026-09-16** (live GitHub is authority over stale issue-body prose).
...
| M002.10 real-workload matrix | #824 | **Open** — remaining #672 child |
| Performance contract | #673 (PR #919) | Contract on `master`; **measured PHYSICAL_ARM64 rows open** |
...
PR [#964](https://github.com/seyal-org/seyal/pull/964) is `Refs #824` only until those gates are green.

Independent review of head `dcbb90faaf870fdabbc543e6947adff2af48c8a3` (2026-09-16, @anulalbs): **NO-GO for close**; **GO for `Refs #824`**. Headed XCUI remains INCONCLUSIVE; manual steps remain ENVIRONMENT_UNSUPPORTED / PLATFORM_LIMITED; SPEC-011 IME fixtures 37–41 unclassified. Keep the #824 assignee. Do not start #673/#837 from that PR.
