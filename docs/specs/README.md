...
- [`SPEC-008-M003-COMMAND-BLOCKS.md`](SPEC-008-M003-COMMAND-BLOCKS.md) — **Proposed:** trusted command boundaries, one logical command Block per Pane submission, one Pane composer, and same-execution full-screen TUI takeover.
