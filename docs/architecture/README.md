...
10. [`ADR-009-COMMAND-BLOCKS-COMPOSER-AND-TUI.md`](ADR-009-COMMAND-BLOCKS-COMPOSER-AND-TUI.md) — **Proposed:** one command per Pane Block, one Pane composer, trusted shell integration, and same-execution TUI takeover.
